...
{
    public static class ExtentionTinkoffData
    {
        internal static async Task<CandleList> GetCandlesTinkoffAsync(this CandleList candleList, string figi, CandleInterval candleInterval, int candlesCount)
        {
            ...
            candleList = new CandleList(figi, candleInterval, candlePayload);
